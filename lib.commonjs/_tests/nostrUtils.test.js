...
describe('convertNpubOrHexAddressToHex function', () => {
    it("should return a valid hex address when a valid npub is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressToHex)(validNpubAddress1)).toBe(validHexAddress1);
    });
    it("should return a valid hex address when a valid hex is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressToHex)(validHexAddress1)).toBe(validHexAddress1);
    });
    it("should return '' when a too long invalid npub is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressToHex)(validNpubAddress1 + "1234")
        // convertNpubOrHexAddressToHex("hello")
        ).toBe('');
    });
    it("should return '' when an invalid npub with valid length is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressToHex)(invalidNpubAddress1)).toBe('');
    });
    it("should return '' when an array of valid npub addresses is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressToHex)([validNpubAddress1, validNpubAddress2])).toBe('');
    });
    it("should return '' when an object with a valid npub address is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressToHex)({ valid: validHexAddress1 })).toBe('');
    });
});
describe('convertNpubOrHexAddressesToHex function', () => {
    it("should return an array with one valid hex if one valid npub is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressesToHex)(validNpubAddress1)).toStrictEqual([validHexAddress1]);
    });
    it("should return an array with one valid hex if one hex is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressesToHex)(validHexAddress1)).toStrictEqual([validHexAddress1]);
    });
    it("should return an array of valid hex if array of valid npubs is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressesToHex)([validNpubAddress1, validNpubAddress2])).toStrictEqual([validHexAddress1, validHexAddress2]);
    });
    it("should return an array of valid hex if array of valid hex is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressesToHex)([validHexAddress1, validHexAddress2])).toStrictEqual([validHexAddress1, validHexAddress2]);
    });
    it("should return an array with a valid hex if an array of valid and invalid hex is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressesToHex)([validHexAddress1, invalidNpubAddress1])).toStrictEqual([validHexAddress1]);
    });
    it("should return an empty array if an array with two invalid hex is passed", () => {
        expect((0, index_1.convertNpubOrHexAddressesToHex)([invalidNpubAddress1, invalidNpubAddress2])).toStrictEqual([]);
    });
});
describe('convertHexOrNpubAddressToNpub function', () => {
    it("should return a valid npub address when a valid hex is passed", () => {
        expect((0, index_1.convertHexOrNpubAddressToNpub)(validHexAddress1)).toBe(validNpubAddress1);
    });
    it("should return a valid npub address when a valid npub is passed", () => {
        expect((0, index_1.convertHexOrNpubAddressToNpub)(validNpubAddress1)).toBe(validNpubAddress1);
    });
    it("should return '' when a too long invalid npub is passed", () => {
        expect((0, index_1.convertHexOrNpubAddressToNpub)(validNpubAddress1 + "1234")).toBe('');
    });
    it("should return '' when a too long invalid hex is passed", () => {
        expect((0, index_1.convertHexOrNpubAddressToNpub)(validHexAddress1 + "1234")).toBe('');
    });
    ...
    // });
    it("should return '' when an array of valid npub addresses is passed", () => {
        expect((0, index_1.convertHexOrNpubAddressToNpub)([validHexAddress1, validHexAddress2])).toBe('');
    });
    it("should return '' when an object with a valid npub address is passed", () => {
        expect((0, index_1.convertHexOrNpubAddressToNpub)({ valid: validHexAddress1 })).toBe('');
    });
});
describe('convertHexAddressesToNpub function', () => {
    it("should return an array with one valid npub if one valid hex is passed", () => {
        expect((0, index_1.convertHexAddressesToNpub)(validHexAddress1)).toStrictEqual([validNpubAddress1]);
    });
    it("should return an array with one valid npub if one npub is passed", () => {
        expect((0, index_1.convertHexAddressesToNpub)(validNpubAddress1)).toStrictEqual([validNpubAddress1]);
    });
    it("should return an array of valid npub if array of valid hex is passed", () => {
        expect((0, index_1.convertHexAddressesToNpub)([validHexAddress1, validHexAddress2])).toStrictEqual([validNpubAddress1, validNpubAddress2]);
    });
    it("should return an array of valid npub if array of valid npub is passed", () => {
        expect((0, index_1.convertHexAddressesToNpub)([validNpubAddress1, validNpubAddress2])).toStrictEqual([validNpubAddress1, validNpubAddress2]);
    });
    // it(
    ...
    it("should return an array with a valid npub if an array of valid and invalid hex is passed", () => {
        expect((0, index_1.convertHexAddressesToNpub)([validHexAddress1, validHexAddress2 + "12345"])).toStrictEqual([validNpubAddress1]);
    });
    // it(
    ...
    // });
    it("should return an empty array if an array with two invalid hex is passed", () => {
        expect((0, index_1.convertHexAddressesToNpub)([validHexAddress1 + "abc", validHexAddress2 + "12345"])).toStrictEqual([]);
    });
});
