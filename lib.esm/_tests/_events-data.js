...
export const validDmpEventConvertedToSpasm = {
    meta: {
        baseProtocol: "dmp",
...
export const validDmpEventSignedClosedConvertedToSpasm = {
...
export const validDmpEventSignedOpenedConvertedToSpasm = {
...
export const validPostWithDmpEventSignedClosedConvertedToSpasm = {
    ...validDmpEventSignedClosedConvertedToSpasm,
    meta: {
        ...validDmpEventSignedClosedConvertedToSpasm.meta,
        convertedFrom: "DmpEventSignedClosed",
...
export const validNostrEventConvertedToSpasmV1_0_0 = {
    meta: {
        baseProtocol: "nostr",
        hasExtraSpasmFields: false,
...
export const validNostrSpasmEventConvertedToSpasmV1_0_0 = {
    meta: {
        baseProtocol: "nostr",
...
export const validNostrEventSignedOpenedConvertedToSpasmV1_0_0 = {
    meta: {
        baseProtocol: "nostr",
        hasExtraSpasmFields: false,
...
export const validNostrSpasmEventSignedOpenedConvertedToSpasmV1_0_0 = {
    meta: {
        baseProtocol: "nostr",
        hasExtraSpasmFields: true,
...
export const validPostWithNostrEventSignedOpenedConvertedToSpasmV1_0_0 = {
...
export const validPostWithNostrSpasmEventSignedOpenedConvertedToSpasmV1_0_0 = {
    ...validNostrSpasmEventSignedOpenedConvertedToSpasmV1_0_0,
    dbId: validPostWithNostrSpasmEventSignedOpened.id,
...
export const validNostrReplyToDmpEventConvertedToSpasmV1_0_0 = {
    meta: {
        baseProtocol: "nostr",
        hasExtraSpasmFields: true,
...
export const validPostWithRssItemConvertedToSpasmV1_0_0 = {
    meta: {
        hasExtraSpasmFields: false,
